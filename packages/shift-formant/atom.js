// atom manifest — wraps the formant-preserving pitch shift per @audio/atom CONTRACT.
// Same FIFO adaptation as @audio/shift-pvoc/atom (stftStream writer bursts → fixed
