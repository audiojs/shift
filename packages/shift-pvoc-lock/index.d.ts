/** Laroche-Dolson peak-locked phase vocoder — peaks scatter to shifted bins, non-peak bins lock phase relative to the nearest peak. */
...
export default function phaseLock(data: Float32Array, options?: PhaseLockOptions): Float32Array
...
export default function phaseLock(options?: PhaseLockOptions): ShiftWriter
