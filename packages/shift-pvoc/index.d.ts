/** SMB/Bernsee bin-shift phase vocoder — true instantaneous frequency per bin from phase advance, independent per-bin phase accumulation. */
...
export default function vocoder(data: Float32Array, options?: VocoderOptions): Float32Array
...
export default function vocoder(options?: VocoderOptions): ShiftWriter
