/** Delay-line (harmonizer) pitch shift — two crossfading read taps sweep a modulated delay window at rate `ratio`, splicing at the best-correlated offset on each wrap. */
export interface DelayOptions {
  ...
  sampleRate?: number
  /** delay-line length in samples, default 2048 — trades flutter rate against transient smear */
  window?: number
  /** splice search radius in samples, default window/4 */
  tolerance?: number
}
...
export default function delay(data: Float32Array, options?: DelayOptions): Float32Array
...
export default function delay(options?: DelayOptions): ShiftWriter
